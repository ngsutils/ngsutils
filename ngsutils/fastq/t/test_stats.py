...
''')
        ...
        self.assertEqual(stats.lengths, [0, 0, 0, 0, 0, 0, 0, 2, 0, 2])
        self.assertEqual(stats.totals, [4, 4, 4, 4, 4, 4, 4, 4, 2, 2])
        self.assertEqual(stats.qualities, [104, 104, 104, 104, 104, 104, 104, 104, 52, 52])  # accumulator
        for q, t in zip(stats.qualities, stats.totals):
        ...
        self.assertEqual(len(stats.quality_stats), 10)
